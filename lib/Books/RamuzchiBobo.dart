...
class _RamuzchiBoboState extends State<RamuzchiBobo> {
  String _text ="Bor ekan-da, yo'q ekan, och ekan-da, to'q ekan, zamonlarning zamonida bir qishloq bor ekan. Bu qishloqda bir hushyor, farosatli, idrokli qari bobo bor ekan. Shu qishloqda yana bir boyvachcha ham bor ekan. Shu boyvachcha ko'chada ketib borayotgan paytda, oldidan juda xushsurat bir qiz chiqib qoldi. Qiz boyvachchaga qarab:Men bir savdogarning qizi edim. Mening otamni qaroqchilar yoʻlda oʻldirdi. Men boʻlsam, bir balo qilib qochib qutuldim. Shu qochganimcha yugurib, yuz ming mashaqqatlar bilan shu yerda sizni ko'rib qoldim. Endi meni olib borib xoh o'zingizga nikoh qiling, xoh xizmatkorlikka oling, deb yolvordi. Boyvachcha qizni uyiga olib kelib, to'y qilib, xotin qilib oldi va u bilan yashab yuraverdi.Keyinchalik shu qishloqdagi odamlardan har kuni bir kishi yo'qola boshladi. Haligi keksa bobo bu ishga hayron qoldi. Bir kuni u boyvachchaning oldida o'tirgan vaqtida, boyvachchaga qarab:Nima uchun sening ranglaring kasalday sarg'ayib qolibdi? Ilgari rangingda qon ko'p edi, – dedi.Ey bobo, ilgari, uylanmasdan burun kuch-quvvatim, qonim ko'p edi. Bilmadim nima ahvol boʻldi, - dedi.Bobo o'ylanib, ko'nglidan ko'p gaplarni o'tkarib, bir hikoya esiga keldi. Hikoya shunday: Bir xil koʻlbar ilonlar borki, ular yerning tagiga kirib qirq yil yotsa, ajdar boʻladi, yana qirq yil yotsa, qiz bo'ladi. Shundan so'ng dunyoda nima istasa, qilib yuraveradi. Magar shunday ilonlardan chiqib, shu boyvachchaga uchragan boʻlmasin», deb, boyvachchaga: - Ey oʻgʻlim, men bir gapni ko'nglimdan o'tkazdim. Ko'nglinga olmasang shuni aytaman, - deb ilon haqidagi hikoyani aytdi: - Magar xotining shu ilonlardan emasmikan. Birinchidan, sening harakating, qoning ketishini, ikkinchidan, qishloq xal- qidan har kecha bir kishining yo'qolishini shundan ko'raman, - dedi.Bola bu so'zlarni eshitib: «Boboning miyasi kamayganga o'xshaydi» deb, o'rnidan turib ketdi. Bir necha kunlardan keyin boyvachchaning ahvoli juda og'irlashib, go'yoki olti oy yotgan kasalday boʻlib, yurish-turishga madori qurib ketdi. Boyvachcha o'zicha ko'p o'ylab, shu boboning oldiga bir boray» deb, asta uning oldiga kelib, bobo bilan ahvol so'rashib, oxirida boboga: - Ey bobo, haqiqatan ham sizning gapingizga achchig'lanib ketgan edim. Endi oʻzimcha o'ylab qarasam, sizning gapingiz to'g'riga o'xshaydi. Shu gapingiz to'g'ri bo'lsa, qanday qilish mumkin? dedi. Bobo: - Ey oʻgʻlim, agar shu voqeani bilay desang, avval oqshom sho'r go'shtlik ovqat pishirib xotiningga yedir, koʻzalarni quruq qo'y, eshiklarni ichidan qulfla. Bir vaqti xotining suvsaydi, koʻzalarni koʻradi. Qarab tur, qani qulflargan eshikdan qanday chiqib ketadi, shundan keyin bilasan. Agar bilsang, sirni hech kimga aytmaysan, unda bir fikr qilamiz, - deb bolani ko'ndirib yubordi. Bola boboning oldidan chiqib, uyiga keldi. Sertuzlik taomlardan yeb, yotadigan paytida koʻzalarni quruq qilib qo'yib, eshikni ichidan qulflab yotdilar. Bola jimjilog'ini tilib, tuz tiqib yotaverdi. Bir vaqt xotini suvsab, har tomonlarni qarab chiqdi, hech qayerda suv yo'q. Keyin bir yumalab bir ilon shakliga kirib, eshik tagidan chiqib ketdi. Borib suv ichib, kelib yotaverdi. Bu ishni ko'rgan boyvachchaning hushi boshidan ketib, yuz ming mashaqqatlar bilan o'zini to'xtatdi. Ertasi erta bilan bobo huzuriga keldi. Boboga boʻlgan voqealarni birin- sirin hikoya qildi. Bobo o'ylanib, keyin: - Ey o'g'lim, uning iloji shuki, sen uyingga borgin, xotiningga: Narigi qishloqda mening bir xolam bor, shu xolam to'yga aytib yuboribdi. Qatlama, boʻgʻirsoq va har xil taomlardan pishir, ikkovimiz to'yga borib kelaylik», deb aytgin. Bu taomlarni pishirgach, bir yaxshi otni topib ol. Qishloqqa borishingda uzun masofalik bir hiyla qilib otdan xotiningni tushir. O'zing otga minib qochsang, u senga yetolmaydi. Oxiri u ilon boʻlib seni quvadi, ammo issiq qumda o'lib ketishi mumkin, - deb yo'l-yo'riqlar o'rgatdi.Boyvachcha boboga rahmat aytib, uyiga borib xotiniga: Narigi qishloqda bir xolam bor edi. Shu to'y qilar emish. Shunga borsak, nima dersan? - deb maslahat qildi. Xotini borishga rozi boʻldi. So'ngra ikkovlashib qatlama, boʻgʻirsoq, yoyma chalpak va har xil taomlardan tayyorlab, boyvachcha bir yaxshi otni topib, otga ikkovlari mingashib boraverdilar. Bir necha tosh yurgandan keyin oldilaridan bir qumlik sahro chiqdi. Shu qumdan yurgach, xotin eriga: -Bu qumdan yurmang, boshqa yo'l toping, - deb ko'p qarshilik qildi. Boyvachcha:U joylarga borishga boshqa yo'l yo'q, o'zi yaqin qoldi, - deb aldab-suldab qumning o'rtasiga yetdi. Qum nihoyatda issiq edi. Bir joyga etgach, boyvachcha bir hiyla qilib otning ayilini yechib tushirib yubordi: - Ey, ish chatoq boʻldi, deb otini to'xtatib, xotiniga: Birpas tushib otga dam beraylik, - desa xotini hech ko'nmadi.Yana bir joyga borib: - Ayilni tortmasa, hech bo'lmaydi, bir tushsang hech nima qilmaydi, - deb nochor xotinini tushirib, ayilini tortar- tortmas chaqqonlik qilib otning ustiga minib, otga qamchi bosdi. Ot esa toʻliqsib boyvachchani ko'tarib ketdi. Xotini boyvachchaning ketidan bir necha qadam quvib, oxiri yetolmagach, bir yumalab ajdar boʻlib quvaverdi. Biyobonning qumi issiqlik qilib, ajdar yurolmasdan keyinda qolib, oxiri yorilib ketdi. Boyvachcha ajdarning uzoqdan qumda sudralib yurolmasdan qumning issig'ligidan yorilib ketganini ko'rdi. U xotinidan qutilib, o'z qishlog'iga qarab keldi. Boboning yo'l ko'rsatishi bilan boyvachcha hamda shu qishloqdagi xalqlar qutulib qoldi. Boyvachcha boboga tahsin-u ofarinlar qildi.Shunday qilib bobo ham bir necha yillar umr ko'rib, yaxshilik bilan murod-maqsadlariga yetdi";
  ...
  Widget build(BuildContext context) {
    ...
    List<String> chagewords=["zamonida","paytda","xushsurat","qarab","savdogarning","qaroqchilar","qochib qutuldim","mashaqqatlar","ko'rib qoldim","xizmatkorlikka","yolvordi","Keyinchalik","hayron qoldi","sarg'ayib qolibdi","qon","ahvol","ilonlar","ajdar","istasa","ko'nglimdan o'tkazdim","Birinchidan","ikkinchidan","ahvoli","go'yoki","asta","ahvol so'rashib","achchig'lanib","oʻzimcha","voqeani","sho`r","koʻzalarni","quruq","qulfla","suvsaydi","sirni","ko'ndirib","jimjilog'ini","qarab chiqdi","yumalab","shakliga","hushi","boshidan","ketib","mashaqqatlar","huzuriga keldi","hiyla","qochsang","quvadi","qumda","maslahat","sahro","aldab","ko'nmadi","tortmasa","nochor","chaqqonlik","minib","qamchi","yorilib","sudralib","qutilib"];
